...
public class RightMidBluePipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        if (rightColorAverage.val[0]> cbThreshold) {
    ...
    public PropPosition getAnalysis() {
        ...
        if ((rightCount > midCount) && (leftCount < rightCount)){
    ...
    public void init(Mat input) {
        ...
        rightImage = cb.submat(rightRect);
